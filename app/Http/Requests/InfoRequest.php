...
class InfoRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            // 'profile_img' => 'mimes:jpeg,jpg,png|required',
            // 'license' => 'required|mimes:doc,pdf,jpeg,jpg,png'
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            // 'profile_img.mimes' => 'Profile Image must be of type jpeg,jpg or png',
            // 'license.required' => 'License is required',
            // 'license.mimes' => 'License must be of type doc,pdf,jpeg,jpg or png',
        ];
    }
}
